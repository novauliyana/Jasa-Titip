            ...
            <div class="row no-gutters">
                ...
                while ($row = mysqli_fetch_assoc($query)) { ?>
                    <div class="card" style="width: 18rem;">
                        <?php echo "<img src='images/" . $row['foto'] . "' class='card-img-top' alt='' width='100px' height='300'>"; ?>
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">
                            ...
                            <p class="card-text" color="black">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                            <p class="card-text"><small class="text-muted">Estimasi kedatangan 3 hari tanggal .... </small></p>
                            <p class="card-text"> Harga : <?php echo $row['hargaBarang'] ?></p>
                            <button class="btn btn-lg btn-primary" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">Lanjutkan Pemesanan</button><?php } ?>
                        </div>
                    </div>
            </div>
