...
$userid = $_SESSION['jastip'];
    ...
    while ($row = mysqli_fetch_array($ret)) {
        ...
        ?>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="disabled-input" class=" form-control-label">Nomor Rekening</label></div>
                                        <div class="col-12 col-md-9"><input class="form-control " id="norek" name="norek" type="text" value="<?php echo $row['rekening']; ?>" required="true" readonly='true'></div>
                                    </div>
