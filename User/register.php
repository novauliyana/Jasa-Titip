...
if (isset($_POST['login'])) {
    ...
    $query = mysqli_query($con, "INSERT INTO `tbluser`(`nama`, `username`, `email`, `nohp`, `alamat`, `gender`, `noktp`, `password`, `foto`, `rekening`) VALUES (
        '$nama',
        '$uname',
        '$email',
        '$nohp',
    ...
    if ($query) {
        echo "<script>alert('User sudah ditambahkan');</script>";
...
<body class="bg-dark">
        ...
        <div class="container">
            <div class="login-content">
                ...
                <div class="login-form">
                    <form method="post" name="regist" enctype="multipart/form-data" onsubmit="return checkpass();">
    ...
    echo $msg;
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="norek" placeholder="4090XXXXXXX" required="true">
                        </div>
                        <div class="form-group">
                            <label>Foto</label>
                            <input type="file" class="form-control" name="foto" required="true">
                        </div>
                        <!-- <div class="checkbox">
