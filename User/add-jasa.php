...
if (strlen($_SESSION['jastip'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "INSERT INTO `tbljasa`
            (`fk_penjasa`, `fk_idkategori`, `negara`, `kota`, `tanggal_pulang`, `caption`, `max_penitip`, `max_harga`) 
            VALUES 
            ('$idlog','$kategori','$negara','$kota','$pulang','$caption','$max', '$maxhrg')");
        if ($query) {
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="add-category.php">Jastip</a></li>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            ...
                                            <select name="kota" class="form-control">
                                                <option m>pilih kota Indonesia</option>
