...
if (strlen($_SESSION['jastip'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "INSERT INTO `tblbarang`
            ( `NamaBarang`, `Merk`, `negara`, `hargaBarang`, `harga_jastip`, `fk_idkategori`, `fk_iduser`, `foto`)
     VALUES ('$NamaBarang','$Merk','$negara','$hargaBarang','$harga_jastip', '$kategori', '$idlogin', '$foto')");
        if ($query) {
