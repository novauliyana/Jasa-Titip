...
if (strlen($_SESSION['jastip'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "update tbluser set foto='$foto' where IDuser='$userid'");
        if ($query) {
            $msg = "Foto Profile berhasil di update.";
        } else {
    ...
    while ($row = mysqli_fetch_array($ret)) {
        ...
        ?>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input class="form-control " id="email" name="foto" type="file" value="<?php echo $row['foto']; ?>"readonly='true'></div>
                                    </div>
